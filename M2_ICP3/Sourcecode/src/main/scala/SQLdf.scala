...
object SQLdf {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read
      ...
      .load("C:\\Users\\Lenovo\\IdeaProjects\\M2_ICP3\\survey.csv")


    //df.show()

    df.write.format("csv").option("header","true").save("C:\\Users\\Lenovo\\IdeaProjects\\M2_ICP3\\output")
    ...
    val lines = sc.textFile("C:\\Users\\Lenovo\\IdeaProjects\\M2_ICP3\\survey.csv")
